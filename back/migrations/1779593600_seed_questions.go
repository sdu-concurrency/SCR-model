...
var vulnerabilitySchema = []map[string]any{
	...
	{
		"label": map[string]string{"en": "3. Processes/organization", "da": "3. Processer/organisation"},
		"items": []map[string]any{
			...
			{"value": "S3_16", "label": map[string]string{"en": "Other (Processes/organization)", "da": "Andet (Processer/organisation)"}},
		},
	},
	{
...
var capabilitySchema = []map[string]any{
	...
	},
	{
		...
		"items": []map[string]any{
			...
			{"value": "K2_15", "label": map[string]string{"en": "Capability of product pruning", "da": "Evnen til at produktsanere"}},
			{"value": "K2_16", "label": map[string]string{"en": "Other (Customers/demand)", "da": "Andet (Kunder/efterspørgsel)"}},
		},
	},
	{
		"label": map[string]string{"en": "3. Product/processes", "da": "3. Produkt/processer"},
		"items": []map[string]any{
	...
	},
	{
		...
		"items": []map[string]any{
			...
			{"value": "K7_2", "label": map[string]string{"en": "Delegated accountability", "da": "Uddelegering og ansvarliggøres"}},
